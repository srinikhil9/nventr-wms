...
export function AppShell({
  ...
  return (
    <>
      ...
      <main className="min-h-screen min-w-0 overflow-hidden pt-14 md:ml-56">
        <div className="mx-auto max-w-[1600px] overflow-x-auto px-4 py-6 sm:px-6 lg:px-8">{children}</div>
      </main>
    </>
  );
}
